...
namespace BDFramework.Asset
{
    ...
    static public class GameAssetHelper
    {
        ...
        static private IEnumerator AndroidCheckAssetPackageVersion(RuntimePlatform platform, Action callback)
        {
            ...
            //复制ArtConfig
            var persistentArtConfigPath = string.Format("{0}/{1}", persistent, BResources.ASSET_BUILDINFO_PATH);
            var streamingArtConfigPath  = string.Format("{0}/{1}", streamingAsset, BResources.ASSET_BUILDINFO_PATH);
