...
namespace BDFramework.UFlux
{
...
#endif
    {
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnPointerUp - "+ this.transform.name);
            }
            if (img != null && img.sprite != null)
            {
        ...
        public void OnPointerExit(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnPointerExit -" + this.transform.name);
            }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnPointerClick - "+ this.transform.name);
            }
            if (ischangeColor == false)
            {
                if (img != null)
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnBeginDrag - "+ this.transform.name);
            }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnDrag - "+ this.transform.name);
            }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnEndDrag - "+ this.transform.name);
            }
        ...
        private void CancelThisClick()
        {
            if (this.isLog)
            {
                Debug.Log("CancelClick - "+ this.transform.name);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            if (this.isLog)
            {
                Debug.Log("OnPointerEnter - "+ this.transform.name);
            }
