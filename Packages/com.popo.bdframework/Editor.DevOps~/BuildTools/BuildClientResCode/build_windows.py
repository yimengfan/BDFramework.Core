...
LOG_PREFIX = "[BuildCode][Windows]"


def main() -> int:
    """执行 Windows 热更代码的 Unity 构建与上传主流程。"""
    return run_platform_resource_build(
        platform_key="windows",
        log_prefix=LOG_PREFIX,
        description="Build Windows hotfix code via Unity batchmode.",
        execute_method="BDFramework.Editor.DevOps.PublishPipeLineCI.BuildCodeWindows",
