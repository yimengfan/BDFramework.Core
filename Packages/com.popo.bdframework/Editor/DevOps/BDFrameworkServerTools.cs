...
namespace BDFramework.Editor
{
    ...
    public class BDFrameworkServerTools
    {
        ...
        public static bool DownloadAssetBundle(RuntimePlatform platform ,string localPath)
        {
            ...
            var url         = BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNUrl + "/Assetbundle";
        ...
        public static void UploadAPK()
        {
            ...
            var  url           = BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNUrl + "/APK";
