...
", MessageType.Info);
                BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNUrl = EditorGUILayout.TextField("SVN地址",  BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNUrl, GUILayout.Width(350));
                BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNAccount = EditorGUILayout.TextField("SVN账号",  BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNAccount, GUILayout.Width(350));
                BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNPsw = EditorGUILayout.TextField("SVN密码",  BDEditorApplication.BDFrameEditorSetting.WorkFollow.AssetBundleSVNPsw, GUILayout.Width(350));
