...
namespace BDFramework.Editor
{
    ...
    public class BDFrameworkServerTools
    {
        ...
        public static bool DownloadAssetBundle(RuntimePlatform platform ,string localPath)
        {
            ...
            var url         = BDEditorApplication.BDFrameWorkFrameEditorSetting.DevOpsSetting.AssetService_SVNUrl + "/Assetbundle";
        ...
        public static void UploadAPK()
        {
            ...
            var  url           = BDEditorApplication.BDFrameWorkFrameEditorSetting.DevOpsSetting.AssetService_SVNUrl + "/APK";
