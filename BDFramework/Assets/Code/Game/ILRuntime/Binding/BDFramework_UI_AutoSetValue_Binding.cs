...
{
    unsafe class BDFramework_UI_AutoSetValue_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(BDFramework.UI.AutoSetValue);
        ...
        {
            return ((BDFramework.UI.AutoSetValue)o).name;
        }
        static void set_name_0(ref object o, object v)
        {
            ((BDFramework.UI.AutoSetValue)o).name = (System.String)v;
        }
