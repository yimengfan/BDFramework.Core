...
{
    unsafe class BDLauncher_Binding
    {
        ...
        {
            return ((BDLauncher)o).IsCodeHotfix;
        }
        static void set_IsCodeHotfix_0(ref object o, object v)
        {
            ((BDLauncher)o).IsCodeHotfix = (System.Boolean)v;
        }
