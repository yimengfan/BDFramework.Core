    ...
    unsafe class System_Linq_Enumerable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("Where", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.IEnumerable<System.Object>), typeof(System.Collections.Generic.IEnumerable<System.Object>), typeof(System.Func<System.Object, System.Boolean>)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(System.Object), typeof(ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter)};
            if (genericMethods.TryGetValue("Select", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.IEnumerable<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>), typeof(System.Collections.Generic.IEnumerable<System.Object>), typeof(System.Func<System.Object, ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("Count", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Int32), typeof(System.Collections.Generic.IEnumerable<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>)))
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Count_5);
            ...
            if (genericMethods.TryGetValue("Distinct", out lst))
            {
                foreach(var m in lst)
                {
                    ...
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Distinct_10);
            ...
            if (genericMethods.TryGetValue("FirstOrDefault", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Attribute), typeof(System.Collections.Generic.IEnumerable<System.Attribute>), typeof(System.Func<System.Attribute, System.Boolean>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Where_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<System.Object, System.Boolean> @predicate = (System.Func<System.Object, System.Boolean>)typeof(System.Func<System.Object, System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = System.Linq.Enumerable.Where<System.Object>(@source, @predicate);
        ...
        static StackObject* Select_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<System.Object, ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter> @selector = (System.Func<System.Object, ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>)typeof(System.Func<System.Object, ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = System.Linq.Enumerable.Select<System.Object, ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>(@source, @selector);
        ...
        static StackObject* Count_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter> @source = (System.Collections.Generic.IEnumerable<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>)typeof(System.Collections.Generic.IEnumerable<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = System.Linq.Enumerable.Count<ILRuntime.Runtime.Adapters.AttributeAdapter.Adapter>(@source);
        ...
        static StackObject* Distinct_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* FirstOrDefault_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<System.Attribute, System.Boolean> @predicate = (System.Func<System.Attribute, System.Boolean>)typeof(System.Func<System.Attribute, System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = System.Linq.Enumerable.FirstOrDefault<System.Attribute>(@source, @predicate);
