...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Net_WebClient_Binding
    {
        ...
        static StackObject* DownloadStringTaskAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.DownloadStringTaskAsync(@address);
