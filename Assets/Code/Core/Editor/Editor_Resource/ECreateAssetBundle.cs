...
public class ECreateAssetBundle
{
    ...
    public static void PackAllResources()
    {
        ...
        //1.获取在Resources根目录
        string rootPath = Path.Combine(Application.dataPath, EditorWindw_GenAssetBundle.g_rootResourceDir);
    ...
    private static void PackageAll()
    {
        ...
        var inAssetPath = EditorWindw_GenAssetBundle.GetPlatformPath(EditorWindw_GenAssetBundle.buildTarget);
        ...
        //使用lz4压缩
        BuildPipeline.BuildAssetBundles(buildDir, BuildAssetBundleOptions.ChunkBasedCompression, EditorWindw_GenAssetBundle.buildTarget);
