...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BDFramework_Core_Tools_BApplication_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_DevOpsPath", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_DevOpsPath_0);
            args = new Type[]{};
        ...
        static StackObject* get_DevOpsPath_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);


            var result_of_this_method = BDFramework.Core.Tools.BApplication.DevOpsPath;
