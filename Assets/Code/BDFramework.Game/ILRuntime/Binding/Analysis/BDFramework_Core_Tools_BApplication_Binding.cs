...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BDFramework_Core_Tools_BApplication_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_BDEditorCachePath_0);


        }


        static StackObject* get_BDEditorCachePath_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
