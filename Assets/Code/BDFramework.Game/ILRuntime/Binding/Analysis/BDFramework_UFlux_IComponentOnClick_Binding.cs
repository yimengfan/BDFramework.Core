...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BDFramework_UFlux_IComponentOnClick_Binding
    {
        ...
        static StackObject* RemoveAllListeners_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BDFramework.UFlux.IComponentOnClick instance_of_this_method = (BDFramework.UFlux.IComponentOnClick)typeof(BDFramework.UFlux.IComponentOnClick).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* AddListener_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            BDFramework.UFlux.IComponentOnClick.OnClickDelegete @action = (BDFramework.UFlux.IComponentOnClick.OnClickDelegete)typeof(BDFramework.UFlux.IComponentOnClick.OnClickDelegete).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
