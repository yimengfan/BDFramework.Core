...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BDFramework_BDLauncher_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_OnBDFrameInitialized_4);
            args = new Type[]{};
            method = type.GetMethod("get_OnBDFrameInitializedForTest", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_OnBDFrameInitializedForTest_5);
        ...
        static StackObject* get_OnBDFrameInitialized_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
