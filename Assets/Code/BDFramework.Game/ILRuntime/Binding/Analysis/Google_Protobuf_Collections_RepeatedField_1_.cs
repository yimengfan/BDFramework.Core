...
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_one_item_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.Protobuf.Collections.RepeatedField<Com.Test.Item.one_item>);
            args = new Type[]{typeof(Com.Test.Item.one_item)};
