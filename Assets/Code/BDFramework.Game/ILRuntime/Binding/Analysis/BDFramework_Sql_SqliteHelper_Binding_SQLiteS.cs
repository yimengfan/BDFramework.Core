...
{
    unsafe class BDFramework_Sql_SqliteHelper_Binding_SQLiteService_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BDFramework.Sql.SqliteHelper.SQLiteService);
            args = new Type[]{};
        ...
        static StackObject* GetTableRuntime_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BDFramework.Sql.SqliteHelper.SQLiteService instance_of_this_method = (BDFramework.Sql.SqliteHelper.SQLiteService)typeof(BDFramework.Sql.SqliteHelper.SQLiteService).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
