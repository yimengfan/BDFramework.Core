...
{
    unsafe class BDFramework_Adaptor_ActionAdaptor_1_String_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BDFramework.Adaptor.ActionAdaptor<System.String>);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new BDFramework.Adaptor.ActionAdaptor<System.String>(@action);
