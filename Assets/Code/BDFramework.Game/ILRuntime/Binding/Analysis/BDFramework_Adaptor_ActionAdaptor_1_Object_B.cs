...
{
    unsafe class BDFramework_Adaptor_ActionAdaptor_1_Object_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BDFramework.Adaptor.ActionAdaptor<System.Object>);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new BDFramework.Adaptor.ActionAdaptor<System.Object>(@action);
