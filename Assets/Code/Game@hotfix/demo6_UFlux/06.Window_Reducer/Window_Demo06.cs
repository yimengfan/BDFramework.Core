...
namespace BDFramework.UFlux.Test
{
    ...
    public class Window_Demo06 : AWindow<Props_HeroDataContent>
    {
        ...
        public override void Init ()
        {
            ...
            //单Reducer监听
            store = StoreFactory.CreateStore<Server_HeroData , Reducer_Demo06> ();
            ...
            //多Reducer 监听演示
            storeWrapper = StoreFactory.CreateStore<Server_HeroData , S_HeroDataDemo6Test> (typeof (Reducer_Demo06) , typeof (Reducer_Demo06Test));
