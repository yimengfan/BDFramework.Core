...
namespace com.putao.hotpudate
{
    public interface IResMgr
    {
        ...
        /// 本地加载根目录
        /// </summary>
        string mLocalHotUpdateResPath { get; set; }
        /// <summary>
        /// 资源管理
        /// </summary>
        ...
        /// <returns></returns>
        string LoadAsync<T>(string objName, Action<bool, T> action, bool isCreateTaskid = true) where T : UnityEngine.Object;
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        string LoadAsync(IList<string> objName, Action<IDictionary<string, UnityEngine.Object>> action);

        /// <summary>
        /// 取消一个加载任务
        /// </summary>
        /// <param name="taskid"></param>
        void  LoadCancel(string taskid);
        /// <summary>
        /// 取消所有加载任务
        /// </summary>
        void LoadAllCalcel();
