...
- All touched Python modules must keep module docstrings current.
- All touched classes and non-trivial functions must keep docstrings current and explain role, contract, fallback, or side effects.
