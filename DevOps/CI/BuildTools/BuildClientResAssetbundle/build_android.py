...
def main() -> int:
    """执行 Android 热更 Assetbundle 的 Unity 构建与上传主流程。"""
    return run_platform_resource_build(
        platform_key="android",
        log_prefix=LOG_PREFIX,
        description="Build Android hotfix assetbundle via Unity batchmode.",
        execute_method="BDFramework.Editor.DevOps.PublishPipeLineCI.BuildAssetbundleAndroid",
