...
LOG_PREFIX = "[BuildCode][iOS]"


def main() -> int:
    """执行 iOS 热更代码的 Unity 构建与上传主流程。"""
    return run_platform_resource_build(
        platform_key="ios",
        log_prefix=LOG_PREFIX,
        description="Build iOS hotfix code via Unity batchmode.",
        execute_method="BDFramework.Editor.DevOps.PublishPipeLineCI.BuildCodeIOS",
