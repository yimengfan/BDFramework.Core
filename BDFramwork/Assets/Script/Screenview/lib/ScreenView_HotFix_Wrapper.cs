...
namespace BDFramwork.ScreenView
{
    ...
    public class ScreenView_HotFix_Wrapper : IScreenView
    {
        ...
        public ScreenView_HotFix_Wrapper(ILRuntimeAppDomain appdomain,string typename)
        {
            ...
            methodMap["set_name"] = type.GetMethod("set_name", 0);
            methodMap["get_isBusy"] = type.GetMethod("get_isBusy", 0);
            methodMap["set_isBusy"] = type.GetMethod("set_isBusy", 0);
            methodMap["get_isLoad"] = type.GetMethod("get_isLoad", 0);
            methodMap["set_isLoad"] = type.GetMethod("set_isLoad", 0);
            methodMap["get_isTransparent"] = type.GetMethod("get_isTransparent", 0);
            methodMap["set_isTransparent"] = type.GetMethod("set_isTransparent", 0);
            //
            methodMap["BeginExit"] = type.GetMethod("BeginExit", 0);
            methodMap["BeginInit"] = type.GetMethod("BeginInit", 0);
            methodMap["Destory"]   = type.GetMethod("Destory", 0);
            methodMap["Update"] = type.GetMethod("Update", 0);
            methodMap["UpdateTask"] = type.GetMethod("UpdateTask", 0);
        }
        public bool isBusy
        {
            get
            {
                return (bool)appdomain.Invoke(methodMap["get_isBusy"], this.ilrobject,null);
            }
            set
            {
                appdomain.Invoke(methodMap["set_isBusy"], this.ilrobject, new object[] { value});
            }
        }
        ...
        public bool isLoad
        {
            get
            {
                return (bool)appdomain.Invoke(methodMap["get_isLoad"], this.ilrobject, null);
            }
            set
            {
                appdomain.Invoke(methodMap["set_isLoad"], this.ilrobject, new object[] { value });
            }
        }
        ...
        public bool isTransparent
        {
            get
            {
                return (bool)appdomain.Invoke(methodMap["get_isTransparent"], this.ilrobject, null);
            }
            set
            {
                appdomain.Invoke(methodMap["set_isTransparent"], this.ilrobject, new object[] { value });
            }
        }
        ...
        public string name
        {
            get
            {
                return (string)appdomain.Invoke(methodMap["get_name"], this.ilrobject, null);
            }
            set
            {
                appdomain.Invoke(methodMap["set_name"], this.ilrobject, new object[] { value });
            }
        }
